...
const GLOSSARIO = [
  ...
  { key:'igc_continuo', sigla:'IGC', nome:'Índice Geral de Cursos (contínuo)', cat:'Qualidade',
    oque:'Média dos CPC dos cursos da instituição no triênio, ponderada por matrículas, combinada com os conceitos da pós-graduação. É da INSTITUIÇÃO, não de um curso. Ausência significa instituição sem cursos avaliados no triênio — não avaliação ruim.',
    escala:'0 a 5', dir:'maior', fonte:'INEP — Indicadores de Qualidade' },
  { key:'igc_faixa', sigla:'IGC (faixa)', nome:'Índice Geral de Cursos (faixa)', cat:'Qualidade',
    oque:'O IGC contínuo convertido em nota inteira de 1 a 5. É o número que aparece nas divulgações oficiais.',
    escala:'1 a 5', dir:'maior', fonte:'INEP — Indicadores de Qualidade' },
  { key:'pos_programas', sigla:'Programas de pós', nome:'Programas stricto sensu em funcionamento', cat:'Qualidade',
    oque:'Mestrados e doutorados da instituição registrados na CAPES. Descreve a face de pesquisa, não os cursos de graduação acompanhados aqui. Ausência significa que a instituição não tem programa — é um fato sobre ela, não dado faltante.',
    escala:'programas', dir:'contextual', fonte:'CAPES / Sucupira' },
  { key:'pos_conceito_medio', sigla:'Conceito CAPES', nome:'Conceito CAPES médio dos programas', cat:'Qualidade',
    oque:'Média dos conceitos dos programas de pós-graduação, numa escala de 1 a 7. NÃO se compara ao IGC nem ao CPC, que vão de 1 a 5 e avaliam outros objetos.',
    escala:'1 a 7', dir:'maior', fonte:'CAPES / Sucupira' },
  ...
  { key:'pct_mulheres', sigla:'% Mulheres', nome:'Mulheres entre ingressantes', cat:'Acesso & equidade',
    ...
    escala:'0 a 100%', dir:'contextual', fonte:'Censo INEP' },
  { key:'pct_ppi', sigla:'% Pretos/pardos/indígenas', nome:'Ingressantes pretos, pardos e indígenas', cat:'Acesso & equidade',
    oque:'Percentual sobre quem DECLAROU cor/raça, não sobre todos os ingressantes. O Censo tem uma quarta resposta — não declarada — e incluí-la no denominador jogaria quem não respondeu no mesmo balde de quem não é PPI, subestimando o indicador. Nacionalmente são 14,4% sem declaração, e a diferença entre as duas contas chega a 6,4 pontos. Veja sempre ao lado a fatia sem declaração.',
    escala:'0 a 100%', dir:'contextual', fonte:'Censo INEP' },
  { key:'pct_cor_nao_declarada', sigla:'% Cor não declarada', nome:'Ingressantes sem declaração de cor/raça', cat:'Acesso & equidade',
    oque:'Fatia dos ingressantes presenciais que não declarou cor ou raça. Quanto maior, menos firme é a leitura do percentual de pretos, pardos e indígenas — é a medida da incerteza daquele número, e por isso anda junto com ele.',
