...
OBRA = "Observatório Nacional da Educação Superior"

# Arquivos canônicos que constituem a Obra (dados tratados + código + apresentação)
# Arquivos canônicos DESTA obra. Os dados por curso ficam de fora do padrão
# recursivo de propósito: são 7 mil arquivos, e incluí-los tornaria o manifesto
# maior que a obra que ele descreve. O que se sela aqui é o trabalho intelectual
# — código, templates, metodologia e os agregados que ele produz.
PADROES = [
    "data/cursos.json",
